...
public class GenerateTextureNumberTest : MonoBehaviour
{
	...
	private void rightDownMountainDistance(){

	}

	private void leftDownMountainDistance(){
		
	}

	private void rightUpMountainDistance(){
		
	}

	private void leftUpMountainDistance(){
		
	}

	private void rightDownWaterDistance(){
		
	}
	
	private void leftDownWaterDistance(){
		
	}
	
	private void rightUpWaterDistance(){
		
	}
	
	private void leftUpWaterDistance(){
		
	}

	private void rightDownFieldDistance(){
		
	}
	
	private void leftDownFieldDistance(){
		
	}
	
	private void rightUpFieldDistance(){
		
	}
	
	private void leftUpFieldDistance(){
